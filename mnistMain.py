...
def create_model():
    ...
    if optimizer == 'adamPaper':
      adam = keras.optimizers.Adam(lr=0, beta_1=0.5, beta_2=0.999, epsilon=None, decay=0.0, amsgrad=amsGrad)
    elif optimizer == 'adamDefault':
      adam = keras.optimizers.Adam(lr=0.001,beta_1=0.9,beta_2=0.999,amsgrad=amsGrad)
    else:
...
def history():
    ...
    # a is append mode which adds to end of file
